...
app.controller("mainCtrl", function ($scope, $q) {
    ...
    self.approveForm = function () {
        web3.eth.contract(documentAbi).at("0xcb1d8464edb698c61f48f33ec88898eb0750ffc8").approveForm(documentLedgerAddress, {from: web3.eth.accounts[0]}, function (error, result) {
            if (!error) {
